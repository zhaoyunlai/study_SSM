...
import com.zylai.mybatis.mapper.CacheMapper;
...
public class CacheMapperTest {
    ...
    /**
     * MyBatis的一级缓存：
     * 一级缓存是SqlSession级别的，即通过同一个SqlSession查询的数据会被缓存
     ...
     * 查询的数据会被缓存，再通过同一个SqlSessionFactory获取的SqlSession查询相同的数据会从
     * 缓存中获取
